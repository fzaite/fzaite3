...
class _FoodListState extends State<FoodList> {
  ...
  Widget build(BuildContext context) {
    return ListView(children: <Widget>[
      _buildFoodCard('assets/images/steak.png', 'Strawberry Cream Waffles', 7.0,
          273, false),
      _buildFoodCard('assets/images/steak.png', 'Croissant blue berry fruit',
          18.0, 241, true),
      _buildFoodCard('assets/images/steak.png', 'Strawberry Cream Waffles',
          18.0, 1546, true),
      _buildFoodCard('assets/images/steak.png', 'Croissant blue berry fruit',
          18.0, 241, false),
